...
- 4d23927: Seed the demo spaces with lowercase keys.
...
- d230114: Scope the demo seeder's emptiness guard to the workspace.
...
- c0951f3: Fill a workspace created with example content: three spaces (handbook, engineering, product) with a
